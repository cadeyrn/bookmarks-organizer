...
- replaced gulp-eslint 6.0.0 with gulp-eslint-new 1.1.2
- updated eslint from version 5.12.1 to 8.7.0 and updated configuration
...
- updated jsdoc from version 3.5.5 to 3.6.9
- updated stylelint from version 9.10.1 to 14.3.0 and updated configuration
